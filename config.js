...
//
global.Owner = ["+94769058379"];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+94769058379"];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+94772108460"];
global.OwnerName = "Menusha";
global.BotName = "DARK SHAM";
global.packname = "🦋 DARK SHAN 🦋";                             //Do not change.
global.author = "Menusha";                               //Do not change.
